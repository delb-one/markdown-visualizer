...
In the previous chapter, you used a volume mount to persist the
...
filesystem you can share with containers. For details about accessing the setting, see [File sharing](/desktop/settings-and-maintenance/settings/#file-sharing).
